...
public class MITMapShuttlesUpdaterTask  extends AsyncTask<String, Void, Void> {
	...
	MapVehicleOverlay vehicleMarkers;
	...
	/***************************************************/
	MITMapShuttlesUpdaterTask(Context ctx, MITMapView mv, RouteItem routeItem) {
